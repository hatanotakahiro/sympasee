...
## タグ機能
こちらの[URL]（http://54.95.42.129/）にアクセスし
メールアドレス: aaa@aaa
パスワード: aaa111
にてログインするとご覧いただけます。
...
## レーティング機能
ログインした状態で、こちらの[URL]（http://54.95.42.129/movies/1/reviews/new）にアクセスするとご覧いただけます。
![demo3](public/images/demo3.gif)

総合評価では参考にならないと考えn

## フォローフォロワー機能
ログインした状態で、[ユーザー詳細表示ページ]（http://54.95.42.129/users/8）から確認することができます。
