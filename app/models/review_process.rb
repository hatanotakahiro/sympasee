class ReviewProcess
  ...
  def save
    ...
    user_story = (review_story.to_i - 5).abs
    user_impact = (review_impact.to_i - 5).abs
    user_impressed = (review_impressed.to_i - 5).abs
    user_happy = (review_happy.to_i - 5).abs
    user_character = (review_character.to_i - 5).abs
    user_beautiful = (review_beautiful.to_i - 5).abs 
